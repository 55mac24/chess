...
public class ChessBoard {
    ...
    // chess definitions
    static int board_start_dim = 0, board_end_dim = 8;
    static int x_index = 0, y_index = 1;
    static int  black_index = 0, white_index = 1, king_index = 2;
    static char white = 'w', black = 'b';
    static char[] pieces = {'R', 'N', 'B', 'Q', 'K', 'B', 'N', 'R', 'P'};

    //Chess Game setup
    ChessPiece[][] chessBoard = new ChessPiece[board_end_dim][board_end_dim];
    static int continueAfterBlockingPiece = -1, breakAfterBlockingPiece = 0;
    private int move = 0;

    //Return codes
    static int  error = -4, check = 0, checkmate = 1, stalemate = 2, invalidMove = -2, canStillPlay = -1;
    ...
    public boolean isPieceOnFifthRank(ChessPiece piece){
    ...
    public boolean isPieceOnFourthRank(ChessPiece piece){
    ...
    public int perform_pawn_operation(String source_point_pawn, String target_point) {
    ...
    public int canMoveMax(char piece) {
    ...
    public ChessPiece swapChessPiece(int source_x, int source_y, int target_x, int target_y) {
    ...
    public String convertBoardIndexToString(int x_int, int y_int) {
    ...
    public ChessPiece getPieceIndexFromChessLocation(String location) {
        int i = 0, j = 1;
        int[] piece_coordinates = convertChessLocationToBoardIndex(location);
        return chessBoard[piece_coordinates[i]][piece_coordinates[j]];
    }

    public ArrayList<ArrayList<ChessPiece>> activeChessBoardPieces(){
    ...
    public boolean canDefenderProtectKingFromEnemy(ArrayList<ChessPiece> activePieces_sameKingColor, ArrayList<Point> enemies){
    ...
    public int isKingInCheckMate(ArrayList<ChessPiece> activePieces_oppositeKingColor,
 ...
 */
    ...
    public ArrayList<Point> getChessPieceInBoard(char color, char piece) {
    ...
    public int isMoveCastle(ChessPiece king, String move) {
    ...
    public boolean canKingCastle(ChessPiece king) {
    ...
    public int game_status(int doesMoveResultInCheck){
    ...
    public boolean performKingCastle(ChessPiece king, String target_point, int isCastleMove) {
    ...
    public int[][] typesOfDirections(char piece, int moved) {
        if (piece == 'R') {
    ...
    public ArrayList<Point> possibleMoves(ChessPiece piece, int howToHandleBlockingPieces) {
            ...
            for (int i = 1; i < steps; i++) {
                ...
                if (inBounds(x_i, y_i)) {
                    if(chessBoard[x_i][y_i].isActive() && chessBoard[x_i][y_i].getColor() == piece_color
                        ...
                        //System.out.println("X_i: " + x_i + " Y_i: " + y_i + " " + chessBoard[x_i][y_i].isActive());
                        moves.add(new Point(x_i, y_i));
                        if(chessBoard[x_i][y_i].isActive() && chessBoard[x_i][y_i].getColor() != piece_color
    ...
    public boolean validateChessMove(ChessPiece piece, String target_point) {
    ...
    public ChessPiece moveChessPiece(String source_point, String target_point) {
